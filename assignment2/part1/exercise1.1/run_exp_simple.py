#!/usr/bin/env python3
"""
Simple script to run CNN experiments for question 1.1
Runs experiments sequentially (no parallelization)
Usage: python run_exp_simple.py
"""
...
def main():
    ...
    print("="*60)
    print("CNN Experiments for Question 1.1")
    ...
    for net_type in NET_TYPES:
        print(f"\n{'#'*60}")
        print(f"# Running {net_type} experiments ({len(CONV_TYPES)} total)")
        print(f"{'#'*60}")
